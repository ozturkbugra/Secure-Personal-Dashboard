...
// Giriş deneme takibi (rate-limit / kademeli kilit) — singleton, bellekte tutulur.
...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        ...
        options.Cookie.IsEssential = true; // Kritik: GDPR/�erez politikas�na tak�lmas�n
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        if (!context.LoginUser.Any())
        {
            ...
            var adminUser = new LoginUser
            {
                ...
                loginuser_namesurname = "Bu�ra �zt�rk",
        ...
        if (!context.ExpenseTypes.Where(x=> x.is_bank == true).Any())
        {
            ...
            {
                expensetype_name = "BANKA HAREKET�",
                is_bank = true,
                expensetype_order = "0",
                description = "",
            };
        ...
        if (!context.PaymentTypes.Where(x=> x.is_bank == true).Any())
        {
            ...
            {
                paymenttype_name = "BANKA HAREKET�",
                is_bank = true,
                paymenttype_order = 0,
                is_creditcard = false,
    ...
    {
        Console.WriteLine("Veri eklerken hata olu�tu: " + ex.Message);
    }
}
